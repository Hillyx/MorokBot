...
def handle_start(message):
    ...
    bot.send_message(message.from_user.id,
            '💰<b>BTC Payforia</b> - Сервис по обмену электронных валют предлагает услуги по быстрому, безопасному и выгодному обмену Bitcoin на Qiwi, Сбербанк, Яндекс.Деньги и Webmoney, а так же бесплатное надежное хранилище Ваших BTC. В рамках сервиса работает партнерская программа, которая позволяет зарабатывать на обменах других участников вместе с нашим сервисом. У нас индивидуальный подход к каждому клиенту, мы всегда готовы предоставить самый лучший курс клиентам с крупными суммами. Меняйте с Payforia!', reply_markup=user_markup, parse_mode='HTML')
        ...
        if c.data == 'Оплатил':
            bot.edit_message_text(
                ...
                text= "✅ <b>Отлично</b>\n\n"
                      ...
                      "Благодарим вас за выбор <b>BTC Payforia</b>.\n", parse_mode='HTML')
