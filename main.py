...
def handle_start(message):
    ...
    bot.send_message(message.from_user.id,
            '💰<b>BTC PAYFORIA</b> - это моментальный обмен Bitcoin на Qiwi, Сбербанк, Яндекс.Деньги и Webmoney, а так же бесплатное хранилище Ваших BTC.', reply_markup=user_markup, parse_mode='HTML')
...
def handle_text(message):
    ...
    def inline(c):
        ...
        if c.data == 'Перевод2':
            ...
            bot.send_message(c.message.chat.id, "<b>Номер:</b> +79234435311\n"
